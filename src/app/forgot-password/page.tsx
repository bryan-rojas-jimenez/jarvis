...
import { KeyRound, ArrowRight, Mail, Lock } from 'lucide-react';
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#f8fafc] p-6">
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center mb-10 text-center">
          ...
          <p className="text-slate-500 font-medium mt-2">Enter your email and new password.</p>
        </div>

        <div className="bg-white p-10 rounded-[40px] shadow-2xl shadow-slate-200/60 border border-slate-100">
          <h2 className="text-xl font-black text-slate-900 mb-8 tracking-tight">Account Recovery</h2>
          ...
          <div className="mt-10 text-center">
            <Link href="/login" className="text-slate-500 hover:text-indigo-600 font-bold text-sm transition-colors underline underline-offset-4 decoration-indigo-200 decoration-2">
              Back to Sign In
            </Link>
          </div>
        </div>
