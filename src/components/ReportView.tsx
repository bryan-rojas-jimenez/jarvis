...
export default function ReportView({ project, progress, completedTasks, pendingTasks }: ReportViewProps) {
  return (
    <div className="min-h-screen bg-white p-8 md:p-20 font-sans text-slate-900">
      ...
      <div className="mb-10 flex justify-between items-center print:hidden bg-slate-50 p-4 rounded-2xl border border-slate-100">
        ...
        <button 
          ...
          className="flex items-center gap-2 px-6 py-3 bg-indigo-600 text-white font-black rounded-xl hover:bg-indigo-700 shadow-lg shadow-indigo-100 transition-all cursor-pointer"
        >
          <Printer size={18} />
